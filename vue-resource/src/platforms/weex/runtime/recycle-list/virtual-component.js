...
import { initLifecycle, callHook } from 'core/instance/lifecycle.md'
...
function initVirtualComponent (options: Object = {}) {
  ...
  registerComponentHook(componentId, 'lifecycle.md', 'attach', () => {
  ...
  registerComponentHook(componentId, 'lifecycle.md', 'detach', () => {
    vm.$destroy()
  })
}
...
export function resolveVirtualComponent (vnode: MountedComponentVNode): VNode {
  ...
  vnode.componentOptions.Ctor = BaseCtor.extend({
    beforeCreate () {
      ...
      registerComponentHook(cid, 'lifecycle.md', 'create', createVirtualComponent)
    },
    beforeDestroy () {
